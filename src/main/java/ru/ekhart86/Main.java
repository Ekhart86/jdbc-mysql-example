...
import ru.ekhart86.dao.SimpleSingerDao;
import ru.ekhart86.dao.SingerDao;
...
public class Main {
    ...
    private static SingerDao singerDao = new SimpleSingerDao();
    ...
    public static void main(String[] args) {
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1993, 2, 1993)).getTime().getTime()));
